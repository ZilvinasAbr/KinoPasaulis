...
namespace KinoPasaulis.Server.Migrations
{
    ...
    [Migration("20161123165809_InitialMigration")]
    partial class InitialMigration
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("KinoPasaulis.Server.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<int?>("CinemaCreatorId");
            ...
            modelBuilder.Entity("KinoPasaulis.Server.Models.CinemaCreator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("KinoPasaulis.Server.Models.ApplicationUser", b =>
                {
                    b.HasOne("KinoPasaulis.Server.Models.CinemaCreator", "CinemaCreator")
                        .WithMany()
                        .HasForeignKey("CinemaCreatorId");
